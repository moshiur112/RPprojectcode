...
def main():
    ...
    if os.path.exists("bookeeping/allimages.txt"):
        os.remove("bookeeping/allimages.txt")
    else:
        print("The file does not exist")
    with open('bookeeping/allimages.txt', 'a') as f:
    ...
    if os.path.exists("surveyrandom.qsf"):
        os.remove("surveyrandom.qsf")
    else:
        print("The file does not exist")
    with open('surveyrandom.qsf', 'a') as f:
